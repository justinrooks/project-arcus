...
//    let valid: String?
    ...
    init(title: String, link: URL, published: Date, summary: String, fullText: String, day: Int?, riskLevel: String?) {
        self.id = UUID()
        self.title = title
        self.link = link
    ...
    // Computed property for truncated preview
    var previewText: String {
        summary.truncateToSentences(count: 3)
    }
}
